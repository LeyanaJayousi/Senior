...
def main_resnet50(data_directory, exp_directory, epochs, batch_size):
    ...
    criterion = torch.nn.MSELoss(reduction='mean')# Defining the loss function (Mean Squared Error Loss)
...
def main_second_resnet50(data_directory, exp_directory, epochs, batch_size):
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=1e-4)#Using Adam optimizer
...
def main_third_resnet50(data_directory, exp_directory, epochs, batch_size):
