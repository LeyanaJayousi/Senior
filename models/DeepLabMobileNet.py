...
def main_mobilenet(data_directory, exp_directory, epochs, batch_size):
    ...
    model = createDeepLabv3_mobileNet()#Creating DeepLab model with MobileNet architecture
    model.train()
    ...
    criterion = torch.nn.MSELoss(reduction='mean')# Define the loss function (Mean Squared Error Loss)
