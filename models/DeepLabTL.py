...
class SegmentationDataset(VisionDataset):
    ...
    def __init__(self,
        ...
        if image_color_mode not in ["rgb", "grayscale"]: # Validate the color mode for images and masks
            raise ValueError(
        ...
        self.image_color_mode = image_color_mode# Set color modes for images and masks
    ...
    def __getitem__(self, index: int) -> Any:# Get the image and mask paths at the specified index
...
def get_dataloader_single_folder(data_dir2: str,
