...
def main_resnet101(data_directory, exp_directory, num_epochs, batch_size, loss_fn, lr, checkpoint_path, log_name, device="cpu"):

    model = createDeepLabv3_101()  # Create the DeepLabv3 model with ResNet50 architecture
    model.train()
